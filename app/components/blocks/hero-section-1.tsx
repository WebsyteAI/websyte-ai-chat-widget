...
export function HeroSection1({ showDemoFade = false }: HeroSection1Props) {
  return (
    <>
      <HeroHeader />
              ...
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  <p className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                    Transform your docs, help articles, and website into an AI
                    assistant that answers customer questions instantly. Reduce
                    support tickets by 40% with one-line setup.
                  </p>
                </AnimatedGroup>
            ...
            <div className="flex w-full justify-between lg:w-auto">
              ...
              >
                <img 
                  ...
                  className="h-8 w-8"
                />
                <span className="text-xl font-bold">Websyte AI</span>
              </Link>
