                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">New: Websyte AI is now live</span>
                                    ...
                                    <p
                                        ...
                                        Transform your docs, help articles, and website into an AI assistant that answers customer questions instantly. Reduce support tickets by 40% with one-line setup.
                                    </p>
                                </AnimatedGroup>
